...
namespace RapidDoc.Controllers
{
    public class ProjectController : BasicController
    {
        ...
        public ProjectController(IProjectService Service, ICompanyService companyService, IAccountService accountService)
        ...
        public ActionResult Grid()
         {
             var grid = new ProjectAjaxPagingGrid(_Service.GetAllView(), 1, false);
        ...
        public JsonResult GetList(int page)
        {
            ...
            return Json(new
            {
                Html = RenderPartialViewToString("_ProjectGrid", grid),
        ...
        [HttpPost]
        public ActionResult Create(ProjectView model)
        {
        ...
        [HttpPost]
        public ActionResult Edit(ProjectView model)
        {
            if (ModelState.IsValid)
            {
                try
