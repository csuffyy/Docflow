...
namespace RapidDoc.Controllers
{
    public class OrganizationController : BasicController
    {
        ...
        public OrganizationController(IOrganizationService Service, ICompanyService companyService, IAccountService accountService)
        ...
        {
            var grid = new OrganizationAjaxPagingGrid(_Service.GetAllView(), 1, false);
        ...
        public JsonResult GetList(int page)
        {
            ...
            return Json(new
            {
                Html = RenderPartialViewToString("_OrganizationGrid", grid),
        ...
        [HttpPost]
        public ActionResult Create(OrganizationView model)
        {
        ...
        [HttpPost]
        public ActionResult Edit(OrganizationView model)
        {
            if (ModelState.IsValid)
            {
                try
