...
namespace RapidDoc.Controllers
{
    public class TaskScheduleController : BasicController
    {
        ...
        {
            IEnumerable<TaskScheduleView> allList= _Service.GetAllView();
            allList.ToList().ForEach(x => { x.MainField = _SystemService.DeleteAllTags(_SystemService.DeleteAllSpecialCharacters(x.MainField));
        ...
        {
            var grid = new TaskScheduleAjaxPagingGrid(_Service.GetAllView(), page, true);
