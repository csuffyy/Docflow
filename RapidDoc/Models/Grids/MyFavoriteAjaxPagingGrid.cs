...
{
    public class MyFavoriteGrid : Grid<DocumentView>
    {
        ...
        public MyFavoriteGrid(IQueryable<DocumentView> items, IReviewDocLogService reviewDocLogService, IDocumentService documentService, IAccountService accountService, ISearchService searchService, IEmplService emplService)
            : base(items)
        {
