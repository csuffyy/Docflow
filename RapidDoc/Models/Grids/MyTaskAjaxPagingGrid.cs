...
{
    public class MyTaskGrid : Grid<DocumentTaskView>
    {
        private IEnumerable<DocumentTaskView> _displayingItems;
        ...
        public MyTaskGrid(IQueryable<DocumentTaskView> items, IReviewDocLogService reviewDocLogService, IDocumentService documentService, IAccountService accountService, ISearchService searchService, IEmplService emplService)
            : base(items)
        {
        ...
        protected override IEnumerable<DocumentTaskView> GetItemsToDisplay()
        {
    ...
    public class MyTaskAjaxPagingGrid : MyTaskGrid
    {
        public MyTaskAjaxPagingGrid(IQueryable<DocumentTaskView> items, int page, bool renderOnlyRows, IReviewDocLogService reviewDocLogService, IDocumentService documentService, IAccountService accountService, ISearchService searchService, IEmplService emplService)
