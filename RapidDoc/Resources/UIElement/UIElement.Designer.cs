...
namespace UIElementRes {
    ...
    public class UIElement {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Имеются заполненные данные, вы можете сохранить документ как черновик, оставшись на странице, в противном случае введенные данные будут удалены..
        /// </summary>
